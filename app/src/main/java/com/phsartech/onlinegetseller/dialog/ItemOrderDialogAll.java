...
public class ItemOrderDialogAll extends DialogFragment implements
        CallBackFucntionAcceptPending,
        CallBackFucntionDeniedPending,
        CallBackFucntionAcceptShipping {
    ...
    public ItemOrderDialogAll(int shop_id, int buyer_id, String control, String image, String name, String email, CallBackFucntionRefreshData callBackFucntionRefreshData) {
    ...
    public static ItemOrderDialogAll display(FragmentManager fragmentManager, int shop_id, int buyer_id, String control, String image, String name, String email, CallBackFucntionRefreshData callBackFucntionRefreshData) {
        ItemOrderDialogAll exampleDialog = new ItemOrderDialogAll(shop_id, buyer_id, control, image, name, email, callBackFucntionRefreshData);
    ...
    private void setView() {
        itemAllOrderAdapter = new ItemAllOrderAdapter(getContext(), list, this, this, this);
