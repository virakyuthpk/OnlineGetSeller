...
public class SaleOnOnlineGetDialog extends DialogFragment {

    private static String TAG = "SaleOnOnlineGetDialog";
    private TextView textView_detail;
    private Toolbar toolbar;

    public static SaleOnOnlineGetDialog display(FragmentManager fragmentManager) {
        SaleOnOnlineGetDialog exampleDialog = new SaleOnOnlineGetDialog();
    ...
    private void setupToolbar() {
        if (toolbar != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                toolbar.setTitle("Sale on OnlineGet");
    ...
    private void getData(String token) {
        ApiHelper.getService().getSaleOnOnlineGet(token).enqueue(new Callback<JsonObject>() {
            @Override
