...
public class ItemAllOrderAdapter extends RecyclerView.Adapter<ItemAllOrderAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (item.getStage() == "Pending") {
            holder.materialButton_positive.setVisibility(View.VISIBLE);
            holder.materialButton_negative.setVisibility(View.VISIBLE);
            ...
            holder.materialButton_negative.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            holder.materialButton_positive.setVisibility(View.VISIBLE);
            holder.materialButton_negative.setVisibility(View.GONE);
            holder.materialButton_positive.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            holder.materialButton_positive.setVisibility(View.GONE);
            holder.materialButton_negative.setVisibility(View.GONE);
        }
    }
