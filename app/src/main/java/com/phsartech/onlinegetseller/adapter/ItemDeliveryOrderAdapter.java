...
public class ItemDeliveryOrderAdapter extends RecyclerView.Adapter<ItemDeliveryOrderAdapter.MyViewHolder> {

    private final LayoutInflater inflater;
    private final List<OrderModel.Data> dataProductList;

    public ItemDeliveryOrderAdapter(Context context, List<OrderModel.Data> list) {
