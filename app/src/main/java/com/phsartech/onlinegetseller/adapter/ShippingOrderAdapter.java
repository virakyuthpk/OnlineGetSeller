...
public class ShippingOrderAdapter extends RecyclerView.Adapter<ShippingOrderAdapter.MyViewHolder> {

    private List<OrderModel.Data> dataProductList;
    private LayoutInflater inflater;
    private CallBackFunctionOnItemClickShipping callBackFunctionOnItemClickShipping;

    public ShippingOrderAdapter(Context context, List<OrderModel.Data> listClear, CallBackFunctionOnItemClickShipping callBackFunctionOnItemClickShipping) {
        inflater = LayoutInflater.from(context);
        this.dataProductList = listClear;
        this.callBackFunctionOnItemClickShipping = callBackFunctionOnItemClickShipping;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.materialCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                callBackFunctionOnItemClickShipping.onItemClickShipping(item.getShop_id(), item.getUser_id(), item.getUser_image(), item.getUser_name(), item.getEmail());
            }
        });
    }
